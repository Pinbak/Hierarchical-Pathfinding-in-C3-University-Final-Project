...
interface IVSCodePluginVars extends VariableType {
	
}
interface IVSCodePluginBehaviors extends Record<string, IBehaviorInstance> {
	
}
interface IVSCodePlugin extends IWorldInstance {
	instVars: IVSCodePluginVars;
...
interface IsprGroundBehaviors extends Record<string, IBehaviorInstance> {
	
}
interface IsprGround extends IWorldInstance {
	instVars: IsprGroundVars;
